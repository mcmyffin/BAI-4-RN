 ...
 */
public class UsernameChangeResponsePacket extends AbstractServerPacket {
    private int statusCode;

    public UsernameChangeResponsePacket(ChatServerThread chatServerThread, String messageString) {
