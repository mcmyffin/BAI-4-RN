 ...
 */
public class UnsupportedClientPacket extends AbstractClientPacket {
    

    public UnsupportedClientPacket(ChatClientThread chatClientThread, String messageString) {
