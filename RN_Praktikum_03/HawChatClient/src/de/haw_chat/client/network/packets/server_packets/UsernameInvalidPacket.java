 ...
 */
public class UsernameInvalidPacket extends AbstractServerPacket {
    private String messageString;

    public UsernameInvalidPacket(ChatServerThread chatServerThread, String messageString) {
    ...
    public void process() {
        JOptionPane.showMessageDialog(null,
                "Der Benutzername " + LoginPacket.requestedUsername + " ist ungültig!",
